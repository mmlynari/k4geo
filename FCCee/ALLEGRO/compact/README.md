...
Added HCalEndcaps_ThreeParts_TileCal_v02.xml, which was migrated to the theta-phi segmentation; unused readout *Readout_phi was removed; fixed radial dimensions, so the outer radius of all three cylinders is the same; renamed nModules to nsegments for number of radial layers in the second cylinder; moved to use updated geometry CaloThreePartsEndcap_o1_v02.  
